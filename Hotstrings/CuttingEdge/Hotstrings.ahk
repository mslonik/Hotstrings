...
;7. Increment library counter.
{
	...
	;Future: Ależ to jest niuans: gdy już istnieje jakiś Hotstring i próbujemy go nadgrać, to najpierw trzeba go wyłączyć. Inaczej zostają pewne włączone właściwości.
